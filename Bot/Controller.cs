...
namespace Bot {
    public static class Controller {
        ...
        {
            if (GetUnits(Units.GHOST).Where(g => g.energy >= 125 
        ...
        {
            var cloak = CreateRawUnitCommand(Abilities.CLOAK);
        ...
        private static void NukeCalldown(Unit ghost)
        {
            ...
            var nukeCalldown = CreateRawUnitCommand(Abilities.NUKE_CALLDOWN);
